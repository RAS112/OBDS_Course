...
#Use Samtools to generate generate QC outputs from sorted.bam

samtools idxstats mapped_reads/ERR1755082_sorted.bam > mapped_reads/ERR1755082_sorted.idxstat
