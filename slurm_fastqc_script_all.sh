...
fastqc  --nogroup --threads 2 --extract -o /project/bras5372/1_linux/rnaseq/fastqc_slurm_exercise /project/shared/resources/1_linux/rnaseq/*fastq.gz 

#fastqc  --nogroup --threads 1 --extract /project/bras5372/1_linux/rnaseq/fastq/*fastq.gz -o /project/bras5372/1_linux/rnaseq/fastqc_slurm_exercise
